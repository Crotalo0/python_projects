...
#Apro una dialog box che richiede una stringa.
...
#APro una dialog box che richiede un integer.
...
#APro una finestra che richiede un float in un determinato range.
